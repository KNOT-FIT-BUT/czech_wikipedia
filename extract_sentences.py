...
#########################################################################################################################################
# Script reads file with paragraphs (generated by czechwiki_extractor.py) and extracts first sentence of each paragraph
# using UDPipe API. Output is a file with first sentence of each wikipage in wikidump.
# USAGE: extract_sentences.py -i paragraphs.txt -o sentences.txt
#########################################################################################################################################
